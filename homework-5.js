...
const currentBudget = (budget) => {
  ...
  } else budget < productPrice;
  {
    console.log(`Вам не хватает '${productPrice}', пополните баланс`);
  }
};
